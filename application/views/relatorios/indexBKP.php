...
<div id="appDesempenho" >
                    ...
                    <table>
                        <tr>
                            <td style="width: 200px;">
                                <div>Valor total no período</div>
                                <div style="color: #C41835; font-weight: bold; font-size: 20px;">R$ {{total_arrecadacao}}</div>
                            </td>                            
                        </tr>
                    </table>
                ...
                <div class="card-body">
                    <table>
                        <tr>                            
                            <td>
                                <div>Total</div>
                                <div style="color: green; font-weight: bold; font-size: 20px;">R$ {{total_fp}}</div>
                            </td>
                        </tr>
                    </table>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header hheader">
                    Total Pedidos por Mês
                </div>
                <div class="card-body">
                    <table>
                        <tr>
                            <td style="width: 200px;">
                                <div>Total Pedidos por mês</div>
                                <div style="color: #C41835; font-weight: bold; font-size: 20px;">R$ {{pedido_total_periodo_mes}}</div>
                            </td>                            
                        </tr>
                    </table>
                    <canvas id="myChartPedidosMes" height="100"></canvas>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <table>
                        <tr>                            
                            <td>
                                <div>Total</div>
                                <div style="color: green; font-weight: bold; font-size: 20px;">R$ {{pedido_qtd_periodo_mes}}</div>
                            </td>
                        </tr>
                    </table>
                    <canvas id="myChartPedidosQtdMes" height="100"></canvas>
                </div>
            </div>
        </div>
    </div>
