...
<head>
  ...
  <!-- Title -->
  <title>Console</title>
  <meta name="description" content="NEXT INGRESSO">
...
<body>
  ...
  <header id="header" class="navbar navbar-expand-lg navbar-fixed navbar-height navbar-flush navbar-container navbar-bordered"
          style="background-color: #f8fafd; border-style: none; height: 74px;">
    <div class="container">
        ...
        <div class="navbar-brand-wrapper">
          <!-- Logo -->
            ...
            <a class="navbar-brand" href="<?= base_url() ?>" aria-label="Front">
              <img class="navbar-brand-logo" src="<?= base_url('images/logo_empresa.png') ?>" alt="Logo">
            </a>
        ...
        <div class="navbar-nav-wrap-content-left collapse navbar-collapse" id="navbarNavMenu">
          <div class="navbar-body">
            <ul class="navbar-nav flex-grow-1">
              <!-- Eventos 
              <li>
                <a class="navbar-nav-link nav-link" href="<?= base_url() ?>">
                  <i class="fa fa-home nav-icon" style="font-size: 15px;"></i> Home
                </a>
              </li>
              <!-- End Eventos -->
              ...
              <li class="hs-has-sub-menu">
                <a id="dashboardsDropdown" class="hs-mega-menu-invoker navbar-nav-link nav-link nav-link-toggle" href="javascript:;" aria-haspopup="true" aria-expanded="false" aria-labelledby="navLinkDashboardsDropdown">
                  <i class="bi bi-file-earmark-text nav-icon" style="font-size: 15px; margin-right: -10px;"></i> Relatórios
                </a>
                ...
                <ul id="navLinkDashboardsDropdown" class="hs-sub-menu dropdown-menu dropdown-menu-lg" aria-labelledby="dashboardsDropdown" style="min-width: 16rem;">
                  <li>
                    <a class="dropdown-item" href="<?= base_url('Diarios/index') ?>">
                      <span class="tio-circle nav-indicator-icon"></span> Financeiro
                    </a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="<?= base_url('Portal/relatorios') ?>">
                      <span class="tio-circle nav-indicator-icon"></span> Estatístico
                    </a>
                  </li>                  
                </ul>
                <!-- End Dropdown -->
