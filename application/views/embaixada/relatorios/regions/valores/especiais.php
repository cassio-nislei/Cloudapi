<?php 
    if (isset($especiais) && is5_count($especiais) > 0) {
        ?>
        <br>
        <table class="ttable">
            <thead>
                <tr>
                    <th colspan="2" class="titulo">OFERTAS ESPECIAIS</th>
                </tr>
                <tr>
