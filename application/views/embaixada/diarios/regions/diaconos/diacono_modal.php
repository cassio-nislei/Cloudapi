<!-- Modal Grupos -->
<div class="modal fade" id="diaconoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <input type="text" id="nome"
                           class="form-control"
                           v-model="diacono.nome">
                </div>
            </div>
            <br>
      </div>
      <div class="modal-footer">        
        <button v-if="loading_diaconos" type="button" class="btn btn-hti" style="width: 120px;"
                disabled="disabled">
            <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
            Aguarde...
        </button>
        <button v-else id="btnSalvarUsuario" type="button" class="btn btn-hti" style="width: 120px;"
                v-on:click="salvarDiacono()">
            Salvar
        </button>
      </div>
    </div>
