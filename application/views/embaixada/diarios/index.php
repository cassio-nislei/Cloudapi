...
?>
<br>
<h3><i class="bi bi-file-earmark-check"></i> Relatório Financeiro</h3>
<div id="appModelo">
    <?php 
    ...
    <div class="row">
        ...
        <div v-show="filiais && filiais.length > 0" class="col-md-6" style="display: none;">
            <label for="data_final" class="caption">Filial</label>
            <select id="filial_id" v-model="filial_id" class="form-control">
                <option value="0">-- TODAS --</option>
                <option v-for="f in filiais" v-bind:value="f.id">
                    {{f.nome}}
                </option>
            </select>
        </div>
        ...
        <div class="col-md-2">
            <button class="btn btn-hti" style="width: 150px; margin-top: 40px;"
                    v-on:click="getAll()"
                    >
        ...
        <?php /*
        <div class="col-md-2">
            <button class="btn btn-hti-out" style="width: 150px; margin-top: 40px;"
                    v-on:click="novo()"
                    >
...
<script>
    ...
    var appModelo = new Vue({
        ...
        data: {
            ...
            total_missoes: 0.00,
            filial_id: 0,
            filiais: <?= json_encode(edf_lista_filiais()) ?>,
        },
        methods: {
            calcTotal() {
                let dizimos = 0.00;
            ...
            getAll() {
                ...
                let filial_id = this.filial_id || 0;

                let url = this.base_url+'Diarios/getAll'
            ...
            novo() {                
                window.location.href = this.base_url+'diarios/novo'                
            },
                    
            editar(id) {   
                window.location.href = this.base_url+'diarios/'+id; 
            },
            
            imprimir(id) {   
                window.location.href = this.base_url+'diarios/pdf/'+id; 
            },
            ...
            excluir(id) {
                ...
                $.post(this.base_url+'diarios/excluir/'+id)
                .done(result => { 
        ...
        mounted() {
            ...
            var hoje = dd + '/' + mm + '/' + yyyy;
            var filial_id = this.filial_id || 0;
