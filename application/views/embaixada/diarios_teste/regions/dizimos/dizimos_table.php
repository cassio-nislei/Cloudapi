...
<div class="card">
    <div class="card-header ccheader">
        ...
        <div class="btn btn-hti pull-right"
             v-on:click="addDizimo()"><i class="bi bi-plus-lg"></i>
            Adicionar
        </div>
        <?php endif; ?>
    </div>
    <div v-if="(dizimos && dizimos.length > 0) || (dizimos_alt && dizimos_alt.length > 0)" class="card-body">
        ...
        <div v-if="dizimos_alt.length > 0" class="div-alteracoes">
            <div v-for="d in dizimos_alt" >
                ...
                <span class="fa fa-close pull-right" title="Excluir" 
                      ...
                      v-on:click="excluirAlteracao(d.id, 'dizimos')"
                      ></span>
                <?php endif; ?>
            </div>
        </div>
