<!-- Modal Grupos -->
<div class="modal fade" id="especialModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <select id="dizimo_fp" v-model="especial.forma_pag_id" class="form-control">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <input type="tel" id="especial_total"
      ...
      <div class="modal-footer">        
        <button v-if="loading_especiais" type="button" class="btn btn-hti" style="width: 120px;"
                disabled="disabled">
            <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
            Aguarde...
        </button>
        <button v-else id="btnSalvarUsuario" type="button" class="btn btn-hti" style="width: 120px;"
                v-on:click="salvarEspecial()">
            Salvar
        </button>
      </div>
    </div>
