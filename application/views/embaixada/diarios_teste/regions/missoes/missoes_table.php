...
<div class="card">
    <div class="card-header ccheader">
        ...
        <div class="btn btn-hti pull-right"
             v-on:click="addMissao()"><i class="bi bi-plus-lg"></i>
            Adicionar
        </div>
        <?php endif; ?>
    </div>
    <div v-if="(missoes && missoes.length > 0) || (missoes_alt && missoes_alt.length > 0)" class="card-body">
        ...
        <div v-if="missoes_alt.length > 0" class="div-alteracoes">
            <div v-for="d in missoes_alt">
                ...
                <span class="fa fa-close pull-right" title="Excluir" 
                      ...
                      v-on:click="excluirAlteracao(d.id, 'missoes')"
                      ></span>
                <?php endif; ?>
            </div>
        </div>
