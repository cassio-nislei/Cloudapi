...
<div id="appPerfil" style="height: 100%;">
    ...
    <div v-show="!loading" style="display: none;">
        <div class="row">
            <div class="col-md-12">
                <h3> <span class="fa fa-cogs"></span> FILIAL</h3>
            </div>            
        </div>
...
<script>
    ...
    var app = new Vue({
        ...
        methods: {
            getDados() {                
                $.get(this.base_url+'Filiais/get/'+this.id)
                .done(result => { 
                    console.log(result);
                    this.loading = false;  
            ...
            salvar() {                    
                ...
                $.post(this.base_url+'Filiais/salvar', {                     
                    registro: this.loja 
                })
                .done(result => {                    
                    let obj = JSON.parse(result);
                    if (obj) {
                        if (obj.status) {
                            ...
                            window.location.href = this.base_url+'filial/'+obj.data.id;
                        } else {
                            alert(obj.msg);
                        } 
                    } else {
