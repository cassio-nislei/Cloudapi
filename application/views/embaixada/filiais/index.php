...
<h3><span class="fa fa-users"></span> FILIAIS</h3>
<div id="appModelo">
    <?php 
...
<script>
    ...
    var appModelo = new Vue({
        ...
        methods: {
            novo() {                
                window.location.href = this.base_url+'filial/novo'                
            },
                    
            editar(id) {   
                window.location.href = this.base_url+'filial/'+id; 
            },
            ...
            excluir(id) {
                ...
                $.post(this.base_url+'Filiais/excluir/'+id)
                .done(result => { 
