<div class="row">
    <div class="col-md-3">
        ...
        <div class="input-group mb-3">                                            
            <input type="text" id="imp_cfop_externo" class="form-control"
                   v-model="registro.IMP_CFOP_EXTERNO"
                   onkeypress="return somenteNumeros(event);"
                   maxlength="5">                    
            
            <button class="btn btn-outline-secondary" type="button"
                    v-on:click="getImpostos('cfop_externo','CFOP EXTERNO')"
                    >
    ...
    <div class="col-md-9">
        ...
        <select id="imp_csosn_externo" v-model="registro.IMP_CSOSN_EXTERNO" class="form-control">
...
<div class="row">    
    <div class="col-md-3">
        ...
        <input id="imp_cod_enq_ipi" type="tel" class="form-control monetario"
               v-model="registro.IMP_COD_ENQ_IPI"
               >
    </div>
    <div class="col-md-3">
        <label class="caption">Fundo Pobreza %</label>
        <input id="imp_fcp" type="tel" class="form-control monetario">
    </div>

    <div class="col-md-3">
        <label class="caption">MVA Normal %</label>
        <input id="imp_mva_normal" type="tel" class="form-control monetario">
    </div>
    <div class="col-md-3">
        <label class="caption">MVA Simples %</label>
        <input id="imp_mva_simples" type="tel" class="form-control monetario">
    </div>
</div>
<div class="row">        
    <div class="col-md-3">
        <label class="caption">GLP %</label>
        <input id="imp_glp" type="tel" class="form-control monetario">
    </div>          
    <div class="col-md-3">
        <label class="caption">GNn %</label>
        <input id="imp_gnn" type="tel" class="form-control monetario">
    </div>
    <div class="col-md-3">
        <label class="caption">GNi %</label>
        <input id="imp_gni" type="tel" class="form-control monetario">
    </div>
