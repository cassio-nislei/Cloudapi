...
<h3><span class="bi bi-file-earmark"></span> NCM's</h3>
<div id="appModelo">
    <?php 
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <select id="filtro" class="form-control">
                ...
                <option value="S">AUDITADOS</option>
    ...
    var appModelo = new Vue({
        ...
        methods: {
                ...
                $.post('<?= base_url('Ncm/salvar') ?>', this.registro)
                  .done(data => {  
                    ...
                    if (obj) {
                        ...
                        alertError('Impossível retornar dados. Tente novamente.');
                    }                    
                  })
                  .fail(error => {
            ...
            pesquisar() {
                ...
                let url = this.base_url+'Ncm/getAll?'+
                      'ncm='+ ncm +
                      '&descricao='+ descricao +
                      '&filtro='+ filtro;
            ...
            setAuditado() {
                ...
                if (id === '') {
                    alertError('O registro ainda não foi salvo.');
                    return false;
                }
                
                $.post('<?= base_url('Ncm') ?>/setAuditado', { id: id })
                .done(data => {                                             
                    let obj = JSON.parse(data);
                    if (obj) {                          
                        if (obj.status) {
