...
<h3><span class="fa fa-users"></span> GRUPOS</h3>
<div id="appModelo">
    <?php 
        include_once APPPATH . 'views/grupos/regions/grupo_modal.php';
        include_once APPPATH . 'views/grupos/regions/permissoes_modal.php';
    ?>
...
<script>
    ...
    var appModelo = new Vue({
        ...
        methods: {
            ...
            editar(id) {   
                $.get(this.base_url+'Grupos/get/'+id)
                .done(data => {                    
            ...
            salvar() {
                $.post(this.base_url+'Grupos/salvar', { registro: this.registro })
                .done(result => {                                                  
            ...
            excluir(id) {
                ...
                $.post(this.base_url+'Grupos/excluir/'+id)
                .done(result => { 
                    let obj = JSON.parse(result);
                    if (obj) {
                        if (obj.status) {
            ...
            getModulos() {
                $.get(this.base_url+'Modulos/getAll')
                .done(data => {    
            ...
            getPermissoes(id) {
                this.loading = true;
                this.permissoes = [];
                $.get(this.base_url+'Grupos/getPermissoes/'+id)
                .done(data => {  
                    this.loading = false;                    
                    let obj = JSON.parse(data);
                    if (obj) {
            ...
            showPermissoes(id) {
                ...
                $("#grupoPermissoesModal").modal('show');
            },
            ...
            this.myTable = $("#tbRegistros").DataTable({     
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        orderable: false,
                        render: function(data, type, row) {
                            return '<i class="fa fa-list" title="Permissões" style="font-size: 20px; cursor: pointer; color: black;" onclick="appModelo.showPermissoes('+data+')" />';
                        }
                    },
                    {
                        data: 'id',
