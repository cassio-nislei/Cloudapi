...
class Dizimos extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->load->model('edf/Dizimos_model', 'modelo');   
    ...
    function getAll() {
        ...
        try {  
            ...
            if ($data) {
                ...
                $data     = $data;
                $total_fp = edf_totais_fp_dizimos($diario_id);
    ...
    function salvar() {
        ...
        try {         
            ...
            $valor        = isset($registro['valor']) ? $registro['valor'] : 0.00;
