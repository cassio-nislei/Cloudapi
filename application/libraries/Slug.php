...
/**
 * Encapsula as funções do Wordpress para criação de Slug
 * baseando-se no artigo[1].
 * 
 * Utilizando as funções retiradas do WP 3.0.
 * 
 * [1] - http://desenvolvimentoparaweb.com/php/urls-amigaveis-slug-a-wordpress/
 * 
 * @author Mauro
 *
 */
class Slug
{
    ...
    /**
     * Chamada da função
     * self::sanitize_title_with_dashes();
     * 
     * @param string $string
     * @return string Filtrada como slug
     */
