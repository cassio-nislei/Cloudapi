...
$username = "isvargas"; $password = 'fce294febe6005cbb7c3a7628f506dbd';

//sobreescrevo aki as variaveis que pretendo alterar
$browserfolder    = "/var/www/html";
if ( isset($_SESSION['diretorio']) && ($_SESSION['diretorio']) ) {
    $diretorio = base64_decode( $_SESSION['diretorio'] );
    $useruploadpath   = "/var/www/html/Uploads/$diretorio/";
    $useruploadfolder = "Uploads/$diretorio"; 
}else {
    $useruploadpath   = "/var/www/html/Uploads/";
    $useruploadfolder = "Uploads";    
}
$foldershistory[] = $useruploadfolder;

#add essa variavel para controlar o size dos arquivos enviados
$maxFileSize = (1024 * 1024) * 2; //1 MB  //1024000 * (5);